			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group mb-4">
						<label>
							<span>Title</span>
							<small style="font-weight:normal; margin-left:5px;">({{ __('тег заголовка HTML, не больше 70 символов, включая пробелы') }}).  {{ __('Если не указано, то будет использоваться название жанра') }}</small>
						</label>
