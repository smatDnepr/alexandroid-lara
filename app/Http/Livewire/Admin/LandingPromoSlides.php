...
class LandingPromoSlides extends Component
{
	public $slides;
	public $img;
	public $thumb;
	...
	protected $listeners = ['startOrderSorting_landing_promo_slides'];


	public function mount()
	{
		$this->slides         = LandingPromoSlide::orderBy('order')->get();
	...
	{
		LandingPromoSlide::find($slide_id)->delete();
		$this->mount();
	}


	public function startOrderSorting_landing_promo_slides($objOrder)
	{
    ...
    {
        return view('livewire.admin.landing-promo-slides');
    }
}
