...
$config = array(
    ...
    *******************/
    ...
    'fixed_path_from_filemanager'             => array( '../../uploads/thumbs1200/', '../../uploads/thumbs600/', '../../uploads/thumbs150/' ), //fixed path of the image folder from the current position on upload folder
    ...
    'fixed_image_creation_width'              => array( 1200, 600, 150 ), //width of image
    'fixed_image_creation_height'             => array( 1200, 600, 150 ), //height of image
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
